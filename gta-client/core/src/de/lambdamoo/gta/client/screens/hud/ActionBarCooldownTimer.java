 ...
 * @author serhiy
 */
public class ActionBarCooldownTimer extends Table {
     ...
     */
    public ActionBarCooldownTimer(boolean clockwise, float width, float height) {
        super();
        ...
        this.cooldownDisplay.setPosition(5, 6);
    ...
    private TextureRegionDrawable cooldownTimer(float remainingPercentage) {
        ...
        // Pixmap.Blending blending = Pixmap.Blending;
